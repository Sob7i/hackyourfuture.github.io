...
<div>
  <Main class="About container">
    ...
    <div class="full-width inputContainer">
      <label for="message">Click to add additional info.</label>
...
// import Upload from "~/components/upload/upload"; //this should be removed anyway.
...
export default {
  ...
  // components: { //removed this in line with removing the component.
  //   Upload
  // },
    ...
    submitFiles() {
      ...
      if (
        ...
        */
        ...
        alert(
          "You must submit assignment link, and screenshot before you submit!"
        );
      }
